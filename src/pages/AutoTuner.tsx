...
const AutoTuner = () => {
  ...
  const [detectedPitchFrequency, setDetectedPitchFrequency] = useState<
    number | null
  >(null);
  ...
  const handlePitchDetected = (pitchData: {
    ...
    setDetectedPitch(pitchData.note);
    setDetectedPitchFrequency(pitchData.frequency);
  };
  ...
  return (
    <div className="centered-container">
      ...
      <AudioVisualizer
        ...
        detectedPitchFrequency={detectedPitchFrequency}
      />
